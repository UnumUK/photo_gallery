...
SECRET_KEY = 'suln8&f)16eo3&6dg+ok*!3_x5=vf3+oaxpfp&4rw1vn6_fz_='

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS= [u'mguo290.pythonanywhere.com']
...
TEMPLATES = [
    {
        ...
        os.path.join(BASE_DIR,'shuttabug', 'templates','shuttabug'),
        PHOTOLOGUE_APP_DIR),
...
STATIC_ROOT = u'/home/mguo290/mysite/static'
STATIC_URL = '/static/'
app_name ='shuttabug'
#STATIC_PATH = u'/home/mguo290/mysite/shuttabug/static'
STATIC_PATH = os.path.join(app_name,'static')
